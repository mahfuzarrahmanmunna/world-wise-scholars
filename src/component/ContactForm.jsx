          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-800">
                <span className="font-medium">Login Required:</span> You need to
                login to submit your enquiry.{" "}
                <button
                  type="button"
      ...
      <form className="mt-6" onSubmit={handleSubmit(onSubmit)} noValidate>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-600"
          ...
          <div>
            ...
            {errors.counsellingMode && (
              <p className="mt-1 text-sm text-red-600">
                {errors.counsellingMode.message}
              </p>
            )}
          </div>
          ...
          <div className="sm:col-span-2 space-y-3 mt-1">
            <label className="flex items-start gap-3">
              ...
              <span className="text-sm text-slate-700">
                I agree to WWS Terms and privacy policy *
              </span>
            </label>
            {errors.agreeTerms && (
            ...
            <label className="flex items-start gap-3">
              ...
              />
              <span className="text-sm text-slate-700">
                I would like to receive updates and offers from WWS
              </span>
            </label>
          </div>
