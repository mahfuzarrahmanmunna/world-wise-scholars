      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            View, update status, and delete applications
          </p>
        </div>
        <button
          onClick={() => navigate(-1)}
      ...
      <div className="bg-white rounded-xl shadow overflow-hidden">
        <div className="px-4 md:px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Showing {filteredApps.length} of {allApp.length} applications
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow border border-gray-200">
          <div className="text-2xl font-bold text-yellow-600">
            {
              allApp.filter((app) => (app.status || "pending") === "pending")
                .length
            }
          </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow border border-gray-200">
          <div className="text-2xl font-bold text-green-600">
            {
              allApp.filter((app) => (app.status || "pending") === "approved")
                .length
            }
          </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow border border-gray-200">
          <div className="text-2xl font-bold text-blue-600">
            {
              allApp.filter((app) => (app.status || "pending") === "processing")
                .length
            }
          </div>
