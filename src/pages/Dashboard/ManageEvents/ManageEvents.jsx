            ...
            >
              <div className="mb-2">
                <p className="text-sm text-gray-600">
                  <span className="font-medium">City:</span> {ev.city}
                </p>
                <p className="text-sm text-gray-600">
                  <span className="font-medium">Month:</span> {ev.month}
                </p>
                <p className="text-sm text-gray-600">
                ...
                <p className="text-sm text-gray-600">
                  <span className="font-medium">Program:</span> {ev.programType}
                </p>
                <p className="text-sm text-gray-600">
                  <span className="font-medium">Deadline:</span> {ev.deadline}
                </p>
              </div>
