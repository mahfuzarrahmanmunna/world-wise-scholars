      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            View, update status, and manage ambassadors
          </p>
        </div>
        <button
          onClick={() => navigate(-1)}
      ...
      <div className="bg-white rounded-xl shadow overflow-hidden">
        <div className="px-4 md:px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Showing {filteredAmbassadors.length} of {ambassadors.length}{" "}
            ambassadors
          </p>
        </div>
        ...
        {filteredAmbassadors.length === 0 ? (
          <div className="p-6 md:p-8 text-center">
            ...
            <p className="text-gray-500">
              No ambassadors match your search criteria.
            </p>
          </div>
        ) : (
          <>
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <optgroup label="Permission Control">
                              <option
                                value="toggle-scholarships"
                                disabled={
                                  updatingPermissions[
                                    `${ambassador._id}-scholarships`
                                  ]
                                }
                              >
                                {updatingPermissions[
                                  ...
                                  ? "⏳"
                                  : selectedRoutes[ambassador._id]?.scholarships
                                    ? "✅"
                                    : "☐"}{" "}
                                Scholarships
                              </option>
                              <option
                                value="toggle-courses"
                                disabled={
                                  updatingPermissions[
                                    `${ambassador._id}-courses`
                                  ]
                                }
                              >
                                {updatingPermissions[
                                  ...
                                  ? "⏳"
                                  : selectedRoutes[ambassador._id]?.courses
                                    ? "✅"
                                    : "☐"}{" "}
                                Courses
                              </option>
                              <option
                                ...
                                disabled={
                                  updatingPermissions[
                                    `${ambassador._id}-events`
                                  ]
                                }
                              >
                                {updatingPermissions[`${ambassador._id}-events`]
                                  ? "⏳"
                                  : selectedRoutes[ambassador._id]?.events
                                    ? "✅"
                                    : "☐"}{" "}
                                Events
                              </option>
                              <option
                                value="toggle-universities"
                                disabled={
                                  updatingPermissions[
                                    `${ambassador._id}-universities`
                                  ]
                                }
                              >
                                {updatingPermissions[
                                  ...
                                  ? "⏳"
                                  : selectedRoutes[ambassador._id]?.universities
                                    ? "✅"
                                    : "☐"}{" "}
                                Universities
                              </option>
                      ...
                      >
                        ...
                        <optgroup label="Permission Control">
                          ...
                          <option
                            value="toggle-courses"
                            disabled={
                              updatingPermissions[`${ambassador._id}-courses`]
                            }
                          >
                            {updatingPermissions[`${ambassador._id}-courses`]
                              ? "⏳"
