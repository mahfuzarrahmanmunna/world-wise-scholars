...
const ManageUni = () => {
  ...
  const Modal = ({ children, onClose }) => {
    return createPortal(
      ...
      >
        <div
          className="bg-white dark:bg-gray-900 dark:text-gray-100 w-full max-w-3xl rounded-lg shadow-2xl p-6 max-h-[90vh] overflow-y-auto"
          ...
          {filteredUniversities.map((uni) => (
            ...
            >
              <div className="mb-2">
                ...
                <p className="text-sm text-gray-600">
                  <span className="font-medium">Ranking:</span> {uni.ranking}
                </p>
              </div>
        ...
        <Modal onClose={handleCloseModal}>
          ...
          >
            ...
            <label className="flex flex-col text-sm">
              ...
              <select
                name="destination"
                defaultValue={editData.destination || ""}
                className="border rounded px-2 py-2"
              >
            ...
            <label className="flex flex-col text-sm">
              ...
              <input
                name="established"
                type="number"
                defaultValue={editData.established || ""}
                className="border rounded px-2 py-2"
            ...
            <label className="flex flex-col text-sm sm:col-span-2">
              ...
              <input
                name="coursesOffered"
                defaultValue={
                  Array.isArray(editData.coursesOffered)
                    ? editData.coursesOffered.join(", ")
                    : editData.coursesOffered || ""
                }
                className="border rounded px-2 py-2"
                placeholder="e.g., Law, Architecture, Computer Science"
              />
            </label>
            <label className="flex flex-col text-sm">
              ...
              <input
                name="tuitionFee"
                defaultValue={editData.tuitionFee || ""}
                className="border rounded px-2 py-2"
                placeholder="e.g., £18,000 - £38,000 per year"
              />
            </label>
            <label className="flex flex-col text-sm sm:col-span-2">
              ...
              <textarea
                ...
                className="border rounded px-2 py-2 h-24"
                placeholder="e.g., English proficiency, personal statement, recommendation letters"
              />
            </label>
            <label className="flex flex-col text-sm">
            ...
            <label className="flex flex-col text-sm">
              ...
              <input
                ...
                className="border rounded px-2 py-2"
                placeholder="e.g., admissions@ucl.ac.uk"
              />
            </label>
            <label className="flex flex-col text-sm sm:col-span-2">
              ...
              <input
                name="campusLocation"
                defaultValue={editData.campusLocation || ""}
                className="border rounded px-2 py-2"
