...
const UniversityDetailsPages = () => {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["university", id], // unique key for caching with id
    queryFn: fetchUniversity, // function that returns data
  });
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            Sorry, we couldn't load the university details.
          </p>
          <button
  ...
  return (
    <>
      <UniversityDetails
        ...
        bannerImage="https://via.placeholder.com/1920x1080?text=University+Banner"
      />
...
export default UniversityDetailsPages;
