...
const ManageScholarship = () => {
  ...
  const Modal = ({ children, onClose }) => {
    return createPortal(
      ...
      >
        <div
          className="bg-white dark:bg-gray-900 dark:text-gray-100 w-full max-w-2xl rounded-lg shadow-2xl p-6 max-h-[90vh] overflow-y-auto"
        ...
        <Modal onClose={handleCloseModal}>
          ...
          >
            <label className="flex flex-col text-sm">
              ...
              <select
                name="studyLevel"
                defaultValue={editData.studyLevel || ""}
            ...
            <label className="flex flex-col text-sm">
              ...
              <input
                name="eligibility"
                defaultValue={editData.eligibility || ""}
                className="border rounded px-2 py-2"
                placeholder="e.g., High school diploma, IELTS/TOEFL"
              />
            </label>
            <label className="flex flex-col text-sm">
            ...
            <label className="flex flex-col text-sm">
              ...
              <input
                ...
                className="border rounded px-2 py-2"
                placeholder="e.g., $25,000 - $55,000 per year"
              />
            </label>
            <label className="flex flex-col text-sm sm:col-span-2">
              ...
              <input
                ...
                defaultValue={
                  Array.isArray(editData.coursesIncluded)
                    ? editData.coursesIncluded.join(", ")
                    : editData.coursesIncluded || ""
                }
                className="border rounded px-2 py-2"
                placeholder="e.g., Engineering, Business Administration, Computer Science"
              />
            </label>
            <label className="flex flex-col text-sm">
